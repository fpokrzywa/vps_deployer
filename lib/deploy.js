...
import { addService, serviceExists, fileExists } from "./compose.js";
import { APPS_ROOT as ROOT, PROXY_DIR as PRXY_DIR, FLUTTER_BIN } from "./config.js";
...
// npm install that always pulls devDependencies (build tools like vite, the
// prisma CLI, etc.) even though the deployer service runs with NODE_ENV=production,
// which would otherwise make npm skip them.
function npmInstall(dir) {
  return {
    label: "npm install (incl. dev deps)",
    cmd: "npm",
